...
BOOST_AUTO_TEST_CASE(ps_address_test)
{
    ...
    for (uint32_t i = 0; i < 1000; i++) {
        auto sk = m.Derive(i);
        {
            ...
            BOOST_CHECK(sk_string.compare(0, 26, Params().Bech32HRP(CChainParams::EGGLING_EXTENDED_SPEND_KEY)) == 0);
        ...
        }
        {
            ...
            BOOST_CHECK(addr_string.compare(0, 12, Params().Bech32HRP(CChainParams::EGGLING_PAYMENT_ADDRESS)) == 0);
    ...
    for (uint32_t i = 0; i < 1000; i++) {
        auto sk = m.Derive(i);
        {
            ...
            BOOST_CHECK(
                    ...
                    Params().Bech32HRP(CChainParams::EGGLING_EXTENDED_SPEND_KEY));
        ...
        }
        {
            ...
            BOOST_CHECK(
                    ...
                    Params().Bech32HRP(CChainParams::EGGLING_PAYMENT_ADDRESS));
