...
COIN_GETDMN='https://github.com/SirElven8/NestEGG/releases/download/v1.4.1.3/nesteggd'
COIN_GETCLI='https://github.com/SirElven8/NestEGG/releases/download/v1.4.1.3/nestegg-cli'
COIN_NAME='NestEGG'
