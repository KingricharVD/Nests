...
class ReorgStakeTest(PivxTestFramework):
    ...
    def check_money_supply(self, expected_piv, expected_zpiv):
        ...
        # verify that nodes have the expected PIV and zEGG supply
        for node in g_info:
    ...
    def run_test(self):
        ...
        # Check PIV and zEGG supply at the beginning
        # ------------------------------------------
        # zEGG supply: 2 coins for each denomination
        ...
        # Verify that PIV and zEGG supplies were properly updated after the spends and reorgs
        self.log.info("Check EGG and zEGG supply...")
