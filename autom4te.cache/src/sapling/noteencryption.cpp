...
)
{
    ...
    crypto_aead_chacha20poly1305_ietf_encrypt(
        ...
        message.begin(), ZC_EGGLING_ENCPLAINTEXT_SIZE,
...
)
{
    ...
    if (crypto_aead_chacha20poly1305_ietf_decrypt(
        ...
        NULL,
        ciphertext.begin(), ZC_EGGLING_ENCCIPHERTEXT_SIZE,
        NULL,
        0,
        cipher_nonce, K) != 0)
    {
...
)
{
    ...
    crypto_aead_chacha20poly1305_ietf_encrypt(
        ciphertext.begin(), NULL,
        message.begin(), ZC_EGGLING_OUTPLAINTEXT_SIZE,
        NULL, 0, // no "additional data"
        NULL, cipher_nonce, K
    );
...
)
{
    ...
    if (crypto_aead_chacha20poly1305_ietf_decrypt(
        plaintext.begin(), NULL,
        NULL,
        ciphertext.begin(), ZC_EGGLING_OUTCIPHERTEXT_SIZE,
        NULL,
        0,
        cipher_nonce, K) != 0)
    {
