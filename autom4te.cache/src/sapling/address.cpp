...
const unsigned char ZCASH_EGGLING_FVFP_PERSONALIZATION[crypto_generichash_blake2b_PERSONALBYTES] =
...
uint256 SaplingFullViewingKey::GetFingerprint() const {
    CBLAKE2bWriter ss(SER_GETHASH, 0, ZCASH_EGGLING_FVFP_PERSONALIZATION);
    ss << *this;
    return ss.GetHash();
}
